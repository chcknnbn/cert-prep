...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-space-900 grid-bg relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative z-10 border-b border-space-600 px-8 py-5">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <ThemeToggle />
            <div className="mono text-space-400 text-xs tracking-widest">SYSTEM READY</div>
          </div>
        </div>
      </header>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-8 py-16">
        ...
        <div className="mb-16 animate-fade-up">
          ...
          <h1 className="display text-5xl font-extrabold text-space-50 leading-tight mb-4">
            시험 대비,<br />
            <span
              className="relative"
              style={{
          ...
          <p className="text-space-300 text-base max-w-xl leading-relaxed">
        ...
        {/* Stats row */}
        <div
          className="grid grid-cols-3 gap-4 mb-12 animate-fade-up"
        ...
        >
          {[
            ...
            <div
              key={stat.label}
              className="border border-space-600 rounded-lg px-5 py-4 bg-space-800"
            >
              <div className="mono text-3xl font-bold text-amber-400 mb-1">{stat.value}</div>
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="mono text-space-400 text-xs tracking-widest">AVAILABLE MISSIONS</div>
          ...
          {certifications.map((cert, i) => {
            ...
            return (
              <button
                ...
                className="bracket-card w-full text-left border border-space-600 rounded-xl bg-space-800 p-6 hover:border-amber-500/60 hover:bg-space-750 transition-all duration-300 group"
                style={{
              ...
              >
                <div className="flex items-start justify-between gap-6">
                  <div className="flex items-start gap-5">
                    {/* Icon */}
                    <div
                      className="mono text-3xl mt-0.5 transition-transform duration-300 group-hover:scale-110 select-none"
                    ...
                    <div>
                      ...
                      <h2 className="display font-bold text-xl text-space-50 group-hover:text-amber-300 transition-colors mb-2">
                        {cert.name}
                      </h2>
                      <p className="text-space-300 text-sm leading-relaxed max-w-lg">
                        {cert.description}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex-shrink-0 flex flex-col items-end gap-3">
                    ...
                    <div className="grid grid-cols-3 gap-3 text-right mt-auto">
                      {[
                        ...
                        <div key={s.label}>
                          <div className="mono text-base font-bold text-space-100">{s.value}</div>
                          <div className="mono text-[10px] text-space-400 tracking-wide">{s.label}</div>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="mt-5 pt-4 border-t border-space-700 flex gap-1.5">
                  {cert.domains.map((domain) => (
                    ...
                    >
                      ...
                      <div className="mono text-[9px] text-space-500 mt-1 text-center">
        ...
        {/* Coming soon */}
        <div className="mt-4 border border-dashed border-space-700 rounded-xl p-6 text-center opacity-40">
          <div className="mono text-space-400 text-xs tracking-widest mb-1">COMING SOON</div>
          <div className="display text-space-300 font-semibold">Azure Fundamentals (AZ-900)</div>
        </div>
      </main>

      {/* Footer */}
      <footer className="relative z-10 border-t border-space-700 px-8 py-4 mt-12">
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          <div className="mono text-space-500 text-xs">
